...
NAME="${NAME:-vllm-awq4-qwen-baseline}"
...
ROOT="${VLLM_AWQ4_ROOT:-/data/qwen36-awq4-dflash/vllm-awq4-qwen}"
...
mkdir -p "$TRITON_CACHE" "$VLLM_CACHE"
...
echo "Started AWQ4 baseline without DFlash on $HOST:$PORT"
